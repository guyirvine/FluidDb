...
class FormatSQLTest < Test::Unit::TestCase
  def test_no_params
      ...
      sql_out = FluidDb.new.format_to_sql( sql_in )
    ...
    def test_single_int_param
        ...
        sql_out = FluidDb.new.format_to_sql( sql_in, params )
    ...
    def test_single_datetime_param
        ...
        assert_equal "SELECT field1, field2 FROM table1 WHERE field3 = '2012-06-01T11:15:00+00:00'", sql_out
    end
